...
class Parser(models.Model):
    ...
    moysklad_api = models.CharField(max_length=1024, unique=True, verbose_name='API мойсклад')
    yandex_api = models.CharField(max_length=1024, unique=True, verbose_name='API Яндекс')
